...
python predict.py -d "Data - Is Epic Intro 2024-03-25" -l "Is Epic Files.txt" -t "Is Epic" -m "models/Is Epic/" -o "predictions/Is Epic Intro Full.csv"
...
python predict.py -d "Data - Needs Respray Full" -l "Needs Respray Files.txt" -t "Needs Respray" -m "models/Needs Respray/" -o "predictions/Needs Respray Full.csv"

########################################################################################################################
# Data - Is GenAI
########################################################################################################################
python train.py -d "Data - Is GenAI - 2024-03-25" -l "Labels-IsGenAI-2024-03-25.csv" -t "Is GenAI" -o "models/Is GenAI/"
python predict.py -d "Data - Is GenAI Full" -l "Is GenAI Files.txt" -t "Is GenAI" -m "models/Is GenAI/" -o "predictions/Is GenAI Full.csv"
